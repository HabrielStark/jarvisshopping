    ...
    <div className="min-h-screen bg-gradient-to-br from-[#0f172a] via-[#1e293b] to-[#312e81]">
      <header className="flex items-center justify-between px-6 py-4 bg-white/10 border-b border-cyan-400/10 backdrop-blur-xl">
        <div className="flex items-center space-x-3">
          <Image src="/logo.png" alt="Jarvis Logo" width={32} height={32} className="rounded-full" />
          <span className="text-2xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-yellow-400 via-cyan-400 to-purple-500">Your Dashboard</span>
        </div>
        {showSignUp && (
          <button
            onClick={() => router.push("/login")}
            className="px-6 py-2 rounded-xl bg-gradient-to-r from-cyan-400 to-purple-500 text-white font-semibold shadow hover:scale-105 transition-transform text-lg"
          >
            Sign Up
          </button>
        )}
